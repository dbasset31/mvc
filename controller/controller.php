...
class Controller {
    ...
    protected function sendMail($email,$objet,$contenu)
        {
            global $txtManager;
            ...
            $mail->Username   = 'admin@donovan-basset.cf';     // login SMTP
            ...
            ##########################
            $mail->setFrom('admin@donovan-basset.cf', 'Admin');  //adresse de l'expéditeur (pas d'accents)
