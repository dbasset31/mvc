                ...
                <form method="POST" action="/admin">
                  <fieldset class="border p-2">
                    ...
                    <div class="row">
                      ...
                      <input type="color" id="h1" name="h1" value="<?php echo $data[1]->couleur_h1; ?>"><br>
                      <label>Couleur des titres H2 :</label>
                      <input type="color" id="h2" name="h2" value="<?php echo $data[1]->couleur_h2; ?>"><br>
                      <label>Couleur des titres H3 :</label>
                      <input type="color" id="h3" name="h3" value="<?php echo $data[1]->couleur_h3; ?>"><br>
